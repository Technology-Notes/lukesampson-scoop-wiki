...
* `depends`: Runtime dependencies for the app which will be installed automatically. We recommend you use `suggest` instead in most cases, because it leaves the decision up to the user whether they want to install the app.
